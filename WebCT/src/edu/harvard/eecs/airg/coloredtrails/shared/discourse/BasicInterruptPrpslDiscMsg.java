 ...
 * A discourse message permitting dicussion of a basic interruption protocol
 * 
 * 
 */
public class BasicInterruptPrpslDiscMsg
        extends DiscourseMessage {
    public BasicInterruptPrpslDiscMsg() {
    }

    public BasicInterruptPrpslDiscMsg(int fromPerGameId,
                                                   int toPerGameId,
                                                   int messageId) {
        super(fromPerGameId, toPerGameId,
                "basicinterrupt", messageId);
    }

    public BasicInterruptPrpslDiscMsg(DiscourseMessage other) {
        super(other);
    }
   

    public String getMsgType() {
        return "basicinterrupt";
    }
    ...
    public BasicInterruptPrpslDiscMsg clone()
    {
        return new BasicInterruptPrpslDiscMsg(this);
    }
}
