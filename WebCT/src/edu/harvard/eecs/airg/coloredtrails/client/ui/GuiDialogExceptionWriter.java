...
/**
 * An exception writer for making XML-RPC requests and displaying errors
 * as a GUI pop-up window.
 *
 * @author Paul Heymann (ct3@heymann.be)
 */
public class GuiDialogExceptionWriter implements ExceptionWriter {
    public void write(String error, Exception e) {
        e.printStackTrace();
        Utility.guiError(error, e.getMessage());
    }
}
