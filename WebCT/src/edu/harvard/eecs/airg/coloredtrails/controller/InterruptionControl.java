...
public class InterruptionControl
{
    ...
    public static void main(String[] args)
    {
        ...
        Game game1 = new Game(controlImpl, playerIDs1, "gameconfigs", "InterruptionConfig", "Special message for game 1");
        Game game2 = new Game(controlImpl, playerIDs2, "gameconfigs", "InterruptionConfig", "Special message for game 2");
