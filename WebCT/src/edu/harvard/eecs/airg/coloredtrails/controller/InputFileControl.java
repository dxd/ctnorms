...
public class InputFileControl
{
    ...
    public static void main(String[] args)
    {
        ...
        ControlImpl controlImpl = new ControlImpl("tcp://ISE-HDM-VS:8088");
        ...
        int i = 0;
		System.out.println("num of players: "+players_list.size());
        ...
        Game game1 = new Game(controlImpl, playerIDs1, "gameconfigs", "WebCTInputFileConfig", "Special message for game 1");
        Game game2 = new Game(controlImpl, playerIDs2, "gameconfigs", "WebCTInputFileConfig", "Special message for game 2");
