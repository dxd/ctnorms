...
/**
 * An interface for the computational agents Proposer and Responder
 * @author ilke
 */
public interface RecipAgentAdaptor extends GameInitializedEventListener, 
GameStartEventListener, GameEndedEventListener, 
PhasesAdvancedEventListener, DiscourseMessageEventListener {
	...
	/**
	 * Called to generate a strategy for a proposal or respond
	 * For a proposer, a strategy simply returns a proposal
	 * For a responder, a strategy is a mapping between a proposal (argument)
	 * and its response.
	 * @param o null for proposer, proposal for responder
	 * @return proposal for the proposal, response (true - false representing accept - reject)
	 * for the responder
	 */
//	public abstract Object strategy(Object o);
