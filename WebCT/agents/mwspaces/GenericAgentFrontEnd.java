...
*/
public final class GenericAgentFrontEnd {
...
public static void main(String[] args) {
    ...
    GenericAgent agent = new GenericAgentImpl();
   ...
   // 	agent.setClientName(args[0]);
    	...
    	log.fatal("You need to specify an id or a name for the agent: GenericAgentFrontEnd [name]");
    }
}
}