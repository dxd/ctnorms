 ...
 * 
 */
public class GroupGame extends GameConfigDetailsRunnable implements PhaseChangeHandler
{
    Logger logr;
    /**
    ...
    */
    protected void assignScores() {
        ...
        for( PlayerStatus ps : gs.getPlayers() ) {
            ...
            System.out.println(new Double(score) + (" offer" + (ps.getPerGameId() == roundProposerID ? "P" : "R")));
        }
    }
    ...
    */
    public void beginPhase(String phasename) {
        ...
        if(phasename.equals("Communication Phase")) {
            ...
            System.out.println(String.valueOf(Round)+ " newround");
            System.out.println(phasename  + " newphase");
    ...
    public void endPhase(String phasename) {
        ...
        // ### automatic movment ###
            ...
            System.out.println(new Date()+" timeStampEndRound"+Round);
            resetPermissionFlags();
            setPermissions();
    ...
    public boolean doDiscourse(DiscourseMessage dm) {
        ...
        if( dm instanceof BasicProposalDiscussionDiscourseMessage ) {
            ...
            System.out.println( bpddm.accepted() ? "accepted" : "rejected" + "offerresponse" + Round + "." + DialogueExchanges);
            System.out.println( new Date() + " timeStampOfferresponse" + Round + "." + DialogueExchanges);
            ...
            //System.out.println(new Double(offerP), "offerP");
            //System.out.println(new Double(offerR), "offerR");
        ...
        //first check type of message
            ...
            System.out.println(offer + " offer"  + Round + "." + DialogueExchanges);
            System.out.println(new Date()+ " timeStampOffer"  + Round + "." + DialogueExchanges);
            double score;
            //Get round's original proposer and responder
            int roundProposerID	=	Round % 2;
            for( PlayerStatus ps : gs.getPlayers() ) {
    ...
    //        System.out.println(result, "offerresponse" + Round);
    ...
    */
    ...
    public void run() {   	
        ...
        System.out.println((Serializable) ServerData.getInstance().getPlayers()+ " playerconnections");
        System.out.println((Serializable) gs.getPlayers()+ " players");
...
//        logr.addAppender(appender);
    ...
    private void loadGame(GameStatus igs) {
        ...
        System.out.println((GameStatus)igs + " round"+Round);
        System.out.println(new Date() +"timeStampStartRound"+Round);
        for(PlayerStatus ps : gs.getPlayers() ){
