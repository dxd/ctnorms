...
<%	
	...
	SimpleLog.write("send Revelation, jsonMsg: " + jsonMsg);
	...
	if (jsonMsg != null) {
		...
		SimpleLog.write("send Revelation, player ID: " + playerID + "recipientID: " + recipientID);
		...
		ClinetControler.GetClinet(id).client.communication.sendDiscourseRequest(crdm);
		
		SimpleLog.write("send Revelation, session id: " + id);
