 ...
 * modules in the multi-object system. It implements {@link TreeModel} interface
...
class ModuleTreeModel implements TreeModel
{
	...
	{
		super();
		// Creates a root node representing the multi-object system
	...
	/**
	 * Adds the node representing certain module in the multi-object system.
	 * 
	...
	/**
	 * Removes the node representing certain module in the multi-object system.
	 * 
