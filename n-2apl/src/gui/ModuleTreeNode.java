 ...
 * the module tree corresponds to one module from a multi-object system, except
 * the root node, which does not have any corresponding module and stands for a
 * multi-object system itself.
 * 
 * @author Michal Cap
 */
class ModuleTreeNode extends Object implements TreeNode
{
	 ...
	 *         node that represents multi-object system
	 */
	...
	/**
	 * Determines whether this node represents the multi-object system.
	 * 
	 ...
	 *         if it represents a multi-object system
	 */
