...
/**
 * Defines interface for an object that listens for changes in the multi-object
...
public interface MASChangeListener
{
	...
	/**
	 * Invoked when a new module has been created in the multi-object system.
	 * 
	...
	/**
	 * Invoked right before a module is removed from the multi-object system.
	 * 
