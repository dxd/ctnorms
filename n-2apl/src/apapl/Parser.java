...
public class Parser
{
	...
	/**
	 * Parses a multi-object system file into a list of lines in the mas file. Such a line is
	 * is represented as a list of strings, in which the first element denotes the name of
	 * the object, the second denotes the name of the specification file and the third until
