 ...
 * object. It is up to the concrete environment implementation to decide whether
 * modules of one object will be presented separately or as one entity.
 * <p />
...
public class Environment implements EnvironmentInterfaceStandard {
     ...
     * an object enters the environment. Note that this method is also invoked each
     * time an object is re-compiled.
     * 
     * @param name the local name of the specific object.
     */
    protected void addAgent(String name) {
    };

    /**
     * This method is invoked when an object operating in this environment is
     * removed. Note that this method is also invoked when an object is
     * recompiled.
     * 
     * @param name the local name of the specific object.
     */
     ...
     * @param receivers the object listed to receive the event. If no
    ...
    /**
     * Creates a new EIS entity corresponding to a 2APL environment object.
     * Associates the EIS entity with the EIS object of the same name. This
     * function enforces the one to one - EIS object to EIS entity - relation,
     * which is needed to fit the framework used in 2APL environments.
     * 
     * @param object both name of the EIS entity to be added and the name of EIS
     *        object to associate the entity with
     */
    ...
    /**
     * Deletes EIS entity corresponding to EIS object. 
     * 
     * @param object the name of EIS entity to be removed  
     */
    ...
    /**
     * This is a list of entities, that are not associated with any object.
     */
    ...
    /**
     * Stores for each object (represented by a string) a set of listeners.
     */
    ...
    /**
     * Sends a percept to an object/several agents via a given array of entities.
     * 
     * @param percept
     * @param entity
     * @throws EnvironmentInterfaceException
    ...
    protected final void addEntity(String entity) throws EntityException {
        ...
        // Adding an entity to EIS corresponds to adding an object in a 2APL
        // environment
        addAgent(entity);
     ...
     * disassociating it from the respective object.
     * 
     * @param entity the id of the entity that is to be removed.
     * @throws PlatformException if the object does not exist.
     */
    ...
    protected final void deleteEntity(String entity) throws EntityException {
        ...
        // Removing an entity in EIS corresponds to removing object in a 2APL
        // environment
        removeAgent(entity);
     ...
     * 2APL environment object of the same name. In order to comply to the
            ...
            for (String entity : entities) {
                if (associatedEntities.contains(entity) == false)
                    throw new ActException("Entity \"" + entity
                            + "\" is not associated to object \"" + agent
                            + "\".");
    ...
    public final LinkedList<Percept> getAllPercepts(String agent,
        ...
        // fail if ther object is not registered
        if (registeredAgents.contains(agent) == false)
