...
public class Parser2apl implements Parser2aplConstants {
  ...
  final public void Base(APLModule m, LinkedList<File> files) throws ParseException {
    ...
    case PCRULEHEAD:
      ...
      break;
    case SANCTIONHEAD:
      jj_consume_token(SANCTIONHEAD);
      Sanctionbase(m.getSanctionbase());
      break;
    case OHEAD:
      jj_consume_token(OHEAD);
      Obase(m.getGoalbase(), m);
      break;
    case PHEAD:
 ...
 Goal g;
    g = LiteralBodyDeadline(true);
                                       {if (true) return g;}
    throw new Error("Missing return statement in function");
  }

  final public Goal Obligation() throws ParseException {
 Goal g;
    g = ObligationBody(true);
                                  {if (true) return g;}
    throw new Error("Missing return statement in function");
  }

  final public Prohibition Prohibition() throws ParseException {
 Prohibition p;
    p = ProhibitionBody(true);
                                   {if (true) return p;}
    throw new Error("Missing return statement in function");
  }
 ...
 Query q;
  ...
  final public void Sanctionbase(Sanctionbase sanctions) throws ParseException {
        Sanction s;
    s = Sanction();
                        sanctions.add(s);
    label_6:
  ...
  final public Sanction Sanction() throws ParseException {
    Literal l;
  ...
  final public void Obase(Goalbase goals, APLModule m) throws ParseException {
        Goal g;
    g = Obligation();
                try {g.unvar(); goals.assertGoal(g);}
                catch (UnboundedVarException e) {{if (true) throw new ParseException("Goal "+g+" is not grounded.");}}
 ...
 Plan p; PlanSeq pl = new PlanSeq();
    if (jj_2_3(2147483647)) {
      ...
      jj_consume_token(LISTR);
                                                                                               pl.setAtomic();{if (true) return pl;}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case NOT:
      case TRUE:
 ...
 Token env; Term timeout = new APLNum(0); APLFunction action; APLVar result = new APLVar();
  ...
  final public PlanSeq ChunkPlan() throws ParseException {
 Plan p; PlanSeq cp = new PlanSeq();
  ...
  final public PlanSeq ChunkPlanWithVar() throws ParseException {
 Plan p; PlanSeq cp = new PlanSeq();
    jj_consume_token(LISTL);
    p = PlanWithVar();
                           cp.addPlan(p);
 ...
 Goal g; Token t; APLIdent moduleId = null;
  ...
  final public PAction PAction() throws ParseException {
 Prohibition p; Token t; APLIdent moduleId = null;
    ...
    t = jj_consume_token(PACTION);
    jj_consume_token(LBRACE);
    p = Prohibition();
    jj_consume_token(RBRACE);
         {if (true) return new PAction(moduleId, t.toString(),p);}
    throw new Error("Missing return statement in function");
  }
 ...
 Query head; Query guard; PlanSeq body; String time;
    if (jj_2_31(2147483647)) {
      ...
      time = AnyName();
         {if (true) return new PGrule(head,guard,body,time);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case NOT:
      case TRUE:
 ...
 Term a;
  ...
  final public Goal LiteralBodyDeadline(boolean sign) throws ParseException {
 String time; Goal g = new Goal(); Literal l; String priority; Literal sanction; APLVar vartime;
    ...
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case DBLRIGHTARROW:
      jj_consume_token(DBLRIGHTARROW);
      priority = AnyName();
                                               g.addPriority(priority);
      break;
    default:
      jj_la1[44] = jj_gen;
      ;
    ...
    case RIGHTARROW:
      jj_consume_token(RIGHTARROW);
      sanction = LiteralBody(sign);
                                                    g.addSanction(sanction);
      break;
    default:
      jj_la1[45] = jj_gen;
      ;
  ...
  final public Goal ObligationBody(boolean sign) throws ParseException {
 String time; Goal g = new Goal(); Literal l; Literal sanction;
  ...
  final public Prohibition ProhibitionBody(boolean sign) throws ParseException {
 Prohibition p = new Prohibition(); Literal l; Literal sanction;
    l = LiteralBody(sign);
                               p.addLiteral(l);
    jj_consume_token(RIGHTARROW);
    sanction = LiteralBody(sign);
                                                   p.addSanction(sanction);
         {if (true) return p;}
    throw new Error("Missing return statement in function");
  }
...
{Token n; Term l,r;}
{
 ...
 APLIdent ident;
  ...
  private boolean jj_3R_29() {
    ...
    if (jj_scan_token(PACTION)) return true;
    if (jj_scan_token(LBRACE)) return true;
  ...
  private boolean jj_3R_70() {
    if (jj_scan_token(NAMEDOT)) return true;
    return false;
  }
  ...
  private boolean jj_3R_69() {
    if (jj_scan_token(NUMNAME)) return true;
    return false;
  }
  ...
  private boolean jj_3R_94() {
    ...
    if (jj_scan_token(RIGHTARROW)) return true;
    if (jj_3R_79()) return true;
    return false;
  }
  ...
  private boolean jj_3R_137() {
    if (jj_scan_token(DBLRIGHTARROW)) return true;
    if (jj_3R_36()) return true;
    return false;
  }

  private boolean jj_3R_136() {
    if (jj_scan_token(DBLCOLON)) return true;
    if (jj_3R_36()) return true;
    return false;
  }
  ...
  private boolean jj_3_31() {
    if (jj_3R_34()) return true;
    if (jj_scan_token(LEFTARROW)) return true;
    if (jj_3R_34()) return true;
    if (jj_scan_token(VERT)) return true;
    if (jj_3R_35()) return true;
    if (jj_scan_token(COLON)) return true;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x1fec0000,0x1fec0000,0x0,0x0,0x0,0x0,0x80000000,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,0x0,0x80000000,0x80000000,0x0,0x80000000,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,0x80000000,0x0,0x0,0x0,0x0,0x0,0x80000000,0x80000000,0x80000000,0x0,0x0,0x80000000,0x40000000,0x0,0x20000000,0x80000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x600000,0x600000,0x100000,0x0,0x98600001,0x100000,0x100000,0x100000,0x0,0x100000,0x100000,0x9becfc13,0x40000000,0x9becfc13,0x9becfc13,0x40000000,0x9becfc13,0x800,0x260f412,0x260fc12,0x98600000,0x40000000,0x40000000,0x9becfc13,0x9becfc13,0x1e00000,0x200,0x8600000,0x8600000,0x0,0x98600001,0x98600001,0x9becfc13,0x0,0x1,0x98600000,0x0,0x10000000,0x0,0x0,0x0,0x0,0x0,0x0,0x100000,0x98600000,0x8600000,0x100000,0x88600000,0x0,0x98600000,0x0,0x0,0x0,0x8600000,0x0,0x0,0x0,0x98600000,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x1f000,0x2000,0x0,0x2,0x47240,0x0,0x0,0x0,0x10,0x0,0x0,0x47240,0x0,0x47240,0x47240,0x0,0x47240,0x1000,0x2000,0x3000,0x47240,0x0,0x0,0x47242,0x47242,0x41000,0x0,0x5b000,0x6240,0x1000,0x47248,0x47248,0x47242,0x41000,0x0,0x47240,0x0,0x0,0x0,0x0,0x400,0x800,0x20,0x10,0x0,0x47240,0x2000,0x0,0x2000,0x20000,0x47240,0x200,0x200,0x4040,0x43000,0x600000,0x600000,0x100,0x47240,};
   }
